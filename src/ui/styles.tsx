...
export const black0 = "#1A1919";
export const black1 = "#333333";
export const black2 = "#4D4C4C";
export const black3 = "#676565";
export const black4 = "#817E7E";
export const black5 = "#9A9898";
export const white = "#F6F6F6";
export const white1 = "#F6F6F6";
export const white2 = "#F1F1F1";
export const white5 = "#E3E3E3";
...
export const LinkText = styled(Link)<ILinkProps>`
  ...
  color: ${(props) => (props.color ? `${props.color}` : black3)};
  ...
  &:hover {
    ...
    box-shadow: ${(props) => props.hshadow && `${props.hshadow}`};
  }
...
export const TextField = styled("input")<IInputProps>`
  ...
  margin-bottom: ${(props) => (props.mbottom ? `${props.mbottom}` : "0px")};
  border: ${(props) => (props.size ? `${props.size}` : "1px")} solid
    ${(props) => (props.border ? `${props.border}` : black3)};
  border: ${(props) => props.noborder && "none"};
  width: ${(props) => (props.width ? `${props.width}` : "100%")};
  height: ${(props) => (props.height ? `${props.height}` : "48px")};
  background: ${(props) => (props.bg ? `${props.bg}` : white1)};
  outline: none;
  font-style: normal;
  line-height: 32px;
  color: ${(props) => (props.color ? `${props.color}` : black3)};
